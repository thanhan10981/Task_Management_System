...
import { useFirebaseLoginMutation, useLoginMutation } from '../composables/useAuthMutations'
...
async function finishAuth(user: Parameters<typeof authStore.setAuth>[1], redirectTarget: string) {
