<template>
  <div class="auth-card">
    ...
    <div class="auth-header">
      ...
      <p class="auth-subtitle">Join TaskFlow and start managing better.</p>
    </div>
    ...
    <form @submit="onSubmit" novalidate class="space-y-4">
      ...
      <div>
        ...
        <div class="relative">
          ...
          <input
            ...
            class="auth-input"
            :class="errors.fullName ? 'auth-input-invalid' : 'auth-input-valid'"
          />
        </div>
        <p v-if="errors.fullName" class="auth-field-error">
      ...
      <div>
        ...
        <p v-if="errors.confirmPassword" class="auth-field-error">
          <svg xmlns="http://www.w3.org/2000/svg" class="auth-field-error-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
          </svg>
    ...
    <div class="auth-divider">
      ...
      <p class="auth-divider-text">Already have an account?</p>
      <div class="auth-divider-line" />
    </div>
    <RouterLink to="/auth/login" class="auth-secondary-link mt-4">
      Sign in instead
    </RouterLink>
    <RouterLink
      to="/auth/guide"
      class="mt-4 flex items-center justify-center gap-2 text-sm font-semibold text-sky-300 transition-colors hover:text-sky-200"
    >
