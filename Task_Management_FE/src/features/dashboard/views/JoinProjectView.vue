...
const title = computed(() => (isJoining.value ? 'Joining project' : 'Join this project?'))
const subtitle = computed(() =>
  isJoining.value
    ? 'Please wait while we add you to the project.'
    : 'You were invited to collaborate on this project. Confirm before joining.'
)

function validateInviteLink() {
  if (!projectId.value) {
...
async function confirmJoin() {
  if (!validateInviteLink() || isJoining.value || !projectId.value) return
